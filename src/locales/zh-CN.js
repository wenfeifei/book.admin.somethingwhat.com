...
export default {
  ...
  'menu.book': '数据列表',
  'menu.book.user-list': '用户数据',
  'menu.book.user-list-detail': '用户数据（详情）',
  'menu.book.user-preference-list': '用户阅读偏好',
  'menu.book.user-order-list': '用户(预)订单',
  'menu.book.user-recharge-list': '用户充值&赠送记录',
  'menu.book.user-consume-list': '消费喵币记录',
  'menu.book.book-readrecord-list': '阅读记录(小说基础信息)',
  'menu.book.book-chapterreadrecord-list': '阅读记录(小说章节信息)',
  'menu.book.book-collections-list': '收藏记录',
  'menu.book.sys-interface-record': '接口访问记录',
  'menu.analysis': '小程序数据助手',
  'menu.analysis.dailysummary': '数据概况',
  'menu.analysis.visittrend': '访问趋势',
  'menu.analysis.visitretain': '访问留存',
  'menu.analysis.userportrait': '用户画像',
  'menu.analysis.visitdistribution': '访问分布',
  'menu.analysis.visitpage': '访问页面',
  'menu.chart': '数据统计',
  'menu.chart.user': 'book用户统计',
  'menu.chart.book-read': '阅读统计',
  'menu.chart.interface': '接口统计',
  'menu.chart.ranking': '排行榜',
  'menu.sys': '系统管理',
  'menu.sys.account': '后台用户管理',
  'menu.sys.whitelist': '接口白名单',
  'menu.sys.book-user-message': '系统消息',
};
