...
const localeInfo = {
  'en-US': {
    messages: require('D:/05.wechat/01.小程序/01.喵喵看书-v2.0.1/03.中后台/book.admin.somethingwhat.com/src/locales/en-US.js').default,
    locale: 'en-US',
    antd: require('antd/lib/locale-provider/en_US'),
    data: require('react-intl/locale-data/en'),
  },
  'zh-CN': {
    messages: require('D:/05.wechat/01.小程序/01.喵喵看书-v2.0.1/03.中后台/book.admin.somethingwhat.com/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
